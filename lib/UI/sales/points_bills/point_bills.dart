...
import '../../../Models/pdf_money_bills.dart';
import '../../../cubit/Client/client_cubit.dart';
import 'package:intl/intl.dart' as intl;

class PointBills extends StatefulWidget {
  const PointBills({Key? key, required this.data}) : super(key: key);
  final ClientModel data;

  @override
  State<PointBills> createState() => _PointBillsState();
}

class _PointBillsState extends State<PointBills> {
          ...
          child: BlocConsumer<ClientCubit, ClientState>(
            ...
            builder: (context, state) {
              ...
              return ConditionalBuilder(
                ...
                builder: (context) => screen(state, clientCubit),
  ...
  Widget screen(state, ClientCubit clientCubit) => SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Directionality(
                ...
                child: TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'النقاط المستبدله',
                    focusedBorder: OutlineInputBorder(
                      borderSide: BorderSide(color: Colors.white),
                    ),
                    labelText: 'النقاط المستبدله',
              ...
              PrintModel(clientCubit.pdfMoneyModel)
            ],
          ),
        ),
      );
  ...
  Widget PrintModel(PdfMoneyModel model) {
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                "حصة الشهر الحالى :    ${model.defaultBalance}",
                                style: TextStyle(
                                    fontSize: width,
                                    color: Colors.black,
                                    fontWeight: FontWeight.bold),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                "الرصيد المرحل من الشهر السابق : ${model.oldBalance}",
                                style: TextStyle(
                                    fontSize: width,
                                    color: Colors.black,
                                    fontWeight: FontWeight.bold),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                "اجمالى الرصيد     ${model.totalBalance}      نقطة",
                                style: TextStyle(
                                    fontSize: width,
                                    color: Colors.black,
                                    fontWeight: FontWeight.bold),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                "النقاط المستبدله  ${model.pointExchanged}   نقطة",
                                style: TextStyle(
                                    fontSize: width,
                                    color: Colors.black,
                                    fontWeight: FontWeight.bold),
  ...
  saveData(ClientCubit clientCubit, id, state) async {
    PostMoneyModel _money = PostMoneyModel(
        pointsQuantity: int.parse(myController.text), clientId: id);
    clientCubit.postMoneyBill(_money);
  }
}
