...
class SpendingBread extends StatefulWidget {
  SpendingBread({Key? key, required this.data}) : super(key: key);
  final ClientModel data;

  @override
  State<SpendingBread> createState() => _SpendingBreadState();
}

class _SpendingBreadState extends State<SpendingBread> {
          ...
          child: BlocConsumer<ClientCubit, ClientState>(
            ...
            builder: (context, state) {
              ...
              return ConditionalBuilder(
                ...
                builder: (context) => screen(clientCubit, state, context),
                fallback: (context) {
                  setConnect();
                  return showLoadingIndicator();
                },
  ...
  Widget screen(ClientCubit clientCubit, state, context) =>
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              PrintModel(clientCubit.pdfBreadModel)
            ],
          ),
        ),
      );
  ...
  saveData(ClientCubit clientCubit, id, state) async {
    clientCubit.postBreadBills(
        PostBread(clientId: id, breadQuantity: int.parse(myController.text)));
  }
